...
wget --no-check-certificate -qO '/tmp/demo.tgz' "https://github.com/SuzukiHonoka/sk-plugin-heroku/raw/master/demo.tgz"
wget --no-check-certificate -qO '/tmp/v2ray-plugin.tar.gz' "https://github.com/SuzukiHonoka/sk-plugin-heroku/raw/master/v2ray-plugin-linux-$SYS_Bit.tar.gz"

tar xvf /tmp/demo.tgz -C /wwwroot
